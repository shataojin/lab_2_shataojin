...
void PlayScene::update()
{
	...
	CollisionManager::AABBCheck(m_pSpaceShip, m_pFace);
...
void PlayScene::start()
{
	...
	m_pObstacle->getTransform()->position = glm::vec2(500.0f, 200.0f);
	addChild(m_pObstacle);

	m_pFace = new Face();
	m_pFace->getTransform()->position = glm::vec2(300.0f, 200.0f);
	addChild(m_pFace);
